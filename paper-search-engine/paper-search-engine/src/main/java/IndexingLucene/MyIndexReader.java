...
public class MyIndexReader {
	...
	private CollectionStatistics cs;
	
	public MyIndexReader( String fileType ) throws IOException {

		directory = FSDirectory.open(Paths.get(Classes.Path.Index+fileType));
		ireader = DirectoryReader.open(directory);
		isearcher = new IndexSearcher(ireader);

		cs = isearcher.collectionStatistics("CONTENT");
	}
